    ...
    return (
        <section className="mb-20">
            <div className="container mx-auto text-center max-w-[1250px] px-4 md:px-6 lg:px-8 xl:px-0">
                ...
                <p className="mb-10 text-lg font-medium text-center ">QuillStacks transforms library management into a seamless, modern experience with intuitive features and real-time updates.</p>
                <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:grid-cols-3">
                    {/* Feature 1 */}
                    <div className="px-4 py-12 transition-transform duration-300 transform bg-white shadow-xl rounded-xl hover:scale-105 hover:shadow-2xl dark:bg-[black]">
                        <div className="flex justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 text-[#009999] mb-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="px-4 py-12 transition-transform duration-300 transform bg-white shadow-xl rounded-xl hover:scale-105 hover:shadow-2xl dark:bg-black">
                        <div className="flex justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 mb-10 text-teal-500 dark:text-teal-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="px-4 py-12 transition-transform duration-300 transform bg-white shadow-xl rounded-xl hover:scale-105 hover:shadow-2xl dark:bg-black">
                        <div className="flex justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 mb-10 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
