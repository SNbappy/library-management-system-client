                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:grid-cols-3">
                    ...
                    <div className="px-4 py-12 transition-transform duration-300 transform bg-white shadow-xl rounded-xl hover:scale-105 hover:shadow-2xl">
                        <div className="flex justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 text-[#003366] mb-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="px-4 py-12 transition-transform duration-300 transform bg-white shadow-xl rounded-xl hover:scale-105 hover:shadow-2xl">
                        <div className="flex justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 mb-10 text-teal-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
